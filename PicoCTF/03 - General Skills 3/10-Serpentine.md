...
webshell y python
```
erik616-picoctf@webshell:~$ wget https://artifacts.picoctf.net/c/36/serpentine.py
--2025-02-20 23:41:49--  https://artifacts.picoctf.net/c/36/serpentine.py
...
2025-02-20 23:41:49 (1.53 GB/s) - 'serpentine.py' saved [2550/2550]

erik616-picoctf@webshell:~$ python3 serpentine.py 
...
erik616-picoctf@webshell:~$ cat serpentine.py 
...
erik616-picoctf@webshell:~$ nano serpentine.py 
[Simplemente invocas print_flag() funcion que ya esta en el codigo pero no se invoca en la opcion b solo la colocas]
erik616-picoctf@webshell:~$ python3 serpentine.py 
