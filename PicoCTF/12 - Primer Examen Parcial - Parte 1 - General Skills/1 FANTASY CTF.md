...
```
Solo nos conectamos como idica y precionamos enter, seleccione 2 veces A mas enters y solto una flag:

erik616-picoctf@webshell:~$ nc verbal-sleep.picoctf.net 64240
...
Flag: picoCTF{m1113n1um_3d1710n_d5787049}
```